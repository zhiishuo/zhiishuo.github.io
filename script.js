const i18n = {
  en: {
    ...
    blog_intro: 'Four short research notes on workflow, AV-RISE, emotion agents, and multimodal emotion models.',
  ...
  zh: {
    ...
    blog_intro: '这里先放 4 篇研究笔记：科研流程范式、AV-RISE、情感 Agent，以及多模态情感模型。',
    blog_1_kicker: '流程',
