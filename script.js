const i18n = {
  en: {
    ...
    hero_tag: "Hi, I'm", hero_name: 'Zhishuo', hero_subtitle: 'Ph.D. candidate in Computer Science, focusing on multimodal learning, affective computing, and robust speech understanding.', hero_now_label: 'Now', hero_now: 'Currently at SCU · Hong Kong from Sep 2026',
    ...
    hero_note: 'in transit',
    hero_role: 'Ph.D. Candidate · Sichuan University & PolyU',
    ...
    projects_title: 'Selected Projects', featured_kicker: 'Featured work · 01',
    projects_note: 'work in progress',
    ...
    news_title: 'News',
    news_note: 'from the notebook',
    news_0: '🌉 In September 2026, I’ll be in Hong Kong for a new chapter of joint Ph.D. training at PolyU and SCU—connecting my research across Chengdu and Hong Kong.',
    ...
    resume_title: 'Resume', resume_label: 'Curriculum Vitae', resume_btn: 'Open CV', resume_note: 'Academic background and selected work.',
  ...
  zh: {
    ...
    hero_tag: '你好，我是', hero_name: '之硕', hero_subtitle: '四川大学计算机专业博士研究生，研究方向为多模态学习、情感计算与鲁棒语音理解。', hero_now_label: '此刻', hero_now: '现于四川大学 · 2026年9月赴香港',
    ...
    projects_title: '代表性项目', featured_kicker: '重点项目 · 01',
    projects_note: '仍在生长',
    ...
    news_title: '新闻',
    news_note: '近况手记',
    news_0: '🌉 2026年9月起，我将赴香港开展 PolyU × SCU 联合培养——从成都到香港，继续把研究做得更远一点。',
    ...
    resume_title: '简历', resume_label: '个人简历', resume_btn: '打开简历', resume_note: '教育背景与代表性工作。',
    portfolio_title: '作品集',
